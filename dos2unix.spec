...
Source0  : https://sourceforge.net/projects/dos2unix/files/dos2unix/7.5.2/dos2unix-7.5.2.tar.gz
Source1  : https://sourceforge.net/projects/dos2unix/files/dos2unix/7.5.2/dos2unix-7.5.2.tar.gz.asc
...
%prep
%setup -q -n dos2unix-7.5.2
cd %{_builddir}/dos2unix-7.5.2
pushd ..
cp -a dos2unix-7.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706030228
...
cp %{_builddir}/dos2unix-%{version}/COPYING.txt %{buildroot}/usr/share/package-licenses/dos2unix/6d21495b5b792e2d783931b7b6505448b8d07907 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/dos2unix/6d21495b5b792e2d783931b7b6505448b8d07907
